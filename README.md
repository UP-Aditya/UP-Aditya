...
Computer Science undergraduate with a strong foundation in data structures, algorithms, and system design. I spend most of my time sharpening problem-solving skills through competitive programming, and the rest building backend systems and automating the infrastructure that runs them. Currently deepening my expertise in cloud-native and DevOps engineering.

---

## About Me

- 🎓 Computer Science undergraduate, focused on algorithmic thinking and clean system design
- 🧠 Competitive programmer — I enjoy breaking down hard problems and writing efficient, optimized solutions
- ⚙️ Backend developer building reliable, scalable APIs and services
- ☁️ DevOps & cloud enthusiast — automating builds, deployments, and infrastructure end to end
- 📚 Continuously learning, currently going deeper into Kubernetes, Terraform, and distributed system design
...
| | |
|---|---|
| 🔭 **Currently Working On** | A secure, automated CI/CD pipeline with policy-as-code checks |
| 🌱 **Currently Learning** | Kubernetes, AWS, CI/CD, Terraform, System Design |
| 🤝 **Open to Collaborate** | Backend systems, DevOps tooling, and competitive programming projects |
| 💬 **Ask Me About** | DSA, Backend Development, Docker, CI/CD, Databases |
| ⚡ **Fun Fact** | I've cleared the UPSC NDA written exam twice |

---

## Competitive Programming

Problem-solving is where I sharpen the way I think about systems. I spend a large part of my time working through algorithmic challenges — not for the rating, but for the habit of breaking a hard problem into something clean, efficient, and provably correct. It's the same discipline I try to bring into backend and infrastructure work.
...
Automated CI/CD pipeline with policy-as-code security checks, cutting manual deployment steps by 70%.
`GitHub Actions` `Docker` `AWS` `SonarQube` `OPA`
[View Repository →](https://github.com/UP-Aditya)

**🚀 NavRakshak — Smart India Hackathon**
ESP32-based emergency alert device with a FastAPI + Supabase backend and a real-time monitoring dashboard.
